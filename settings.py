...
# Inspired by "2 Scoops of Django": https://django.2scoops.org/
import os
...
ALLOWED_HOSTS = ['%s' % get_env_variable('HEROKU_HOST')]
...
DATABASES = {'default': dj_database_url.config(default='postgres://localhost/%s' % PROJECT_DIRNAME)}
